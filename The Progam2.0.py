...
print("Hello and welcome to Henderson Pizza Palace!\n")


#ASK USER IF DELIVERY OR PICKUP ADD $3 IF DELIVERY
delivery_method = input("Would you like, delivery is $3 \na. Delivery b. Pickup\n").strip().lower()
if delivery_method == 'a':
    cust_name = input("Please enter your name\n")
    cust_adress = input("Please enter your adress\n")
    cust_phone = int(input("Please enter your phone number\n"))
elif delivery_method == 'b':
    cust_name = input("Please enter your name\n")
...
def pizzapicker():
    ...
    custom_pizzas = []
    a = 1
    pizza_total = int(input("How many pizzas would you like to order {}?\nIf you would like to cancel your order at anytime please enter a blank value and your order will be terminated\n".format(cust_name)))
    i = pizza_total
...
def pizzamaker(pizza_total,custom_cost,pizza_order,custom_pizzas,a,i,drink_order):
    while i > 0 and i <= 5:
        ...
        if pizza == 1:
            ...
            while int(pizza) <= 0 and int(pizza) >= 12:
                pizza = int(input(" Pizza {}/{} flavour:\n1. Pepperoni\n2. Hawaiian\n3. Cheese\n4. Sausage\n5. Vegetable\n6. Margherita\n7. BBQ Chicken\n8. Buffalo\n9. Supreme\n10. Calzone\n11. Meat Lovers\n12. Custom\n".format(a,pizza_total)))
    if i > 5:
        print("Limit of 5 pizzas per order, for special inquiries please contact customer service\n")
        pizzapicker()
...
#Drink picker: Allows user to pick a drink and adds to total and stores in reciept
...
def calculator(pizza_order,custom_cost,custom_pizzas,drink_order):
    ...
    print("Total Cost: ${}\n".format(total_cost))
    print("Thank you for shopping at Henderson Pizza Palace {}".format(cust_name))
    print("----------=+=----------")
    hold = input("Press enter to place another order")
    pizzapicker()
